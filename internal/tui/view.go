...
func (m Model) View() tea.View {
	...
	sections = append(sections, RenderHeader(m.Cfg.Model, m.Cfg.Mode, m.TokenCount, m.TokenMax, m.Cfg.WorkDir, width, m.CompressedTurns, m.Cfg.Stream, m.UpdateStatus, m.UpdateNewVersion))
